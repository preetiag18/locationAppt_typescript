...
function searchLocationHandler(event) {
    event.preventDefault();
    const enteredAdress = addressInput.value;
    axios_1.default
        .get(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURI(enteredAdress)}en&key=${GOOGLE_API_KEY}`)
        .then((response) => {
